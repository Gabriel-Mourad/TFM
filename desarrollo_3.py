...
from vgg16_D3 import inference_d3a, inference_d3brl, inference_d3bCENT
...
class D_3_Machine(StateMachine):
...
if __name__ == '__main__':
    try:
        ...
        while(control==True):
            ...
            elif control_mov.is_busca_center and y_dest==0:
                control_mov.center_destino()
            
            elif control_mov.is_inicio and y_cent==0:
                control_mov.start_center()
            elif control_mov.is_busca_right and y_cent==0:
                control_mov.right_center()
            elif control_mov.is_busca_left and y_cent==0:
                control_mov.left_center()
            elif control_mov.is_busca_center and y_cent==0:
